  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-neutral-900 border border-neutral-800 rounded-2xl max-w-4xl w-full max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
        ...
        {/* Tab Content Area */}
        <div className="p-6 overflow-y-auto space-y-6 text-base text-neutral-300 leading-relaxed">
          {/* TAB 1: QUICK START */}
          {activeTab === 'quickstart' && (
            <div className="space-y-5">
              <div className="bg-indigo-950/40 border border-indigo-900/50 rounded-xl p-4">
                <h3 className="text-base font-semibold text-indigo-200 mb-1 flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-neutral-950/80 border border-neutral-800 p-4 rounded-xl space-y-2">
                  <div className="w-7 h-7 rounded-lg bg-indigo-500/20 text-indigo-300 font-bold text-sm flex items-center justify-center">
                    1
                  </div>
                  <h4 className="text-sm font-bold text-neutral-100">Load Your Photo</h4>
                ...
                <div className="bg-neutral-950/80 border border-neutral-800 p-4 rounded-xl space-y-2">
                  ...
                  <h4 className="text-sm font-bold text-neutral-100">Pick Target Ratio</h4>
                  <p className="text-sm text-neutral-400">
                ...
                <div className="bg-neutral-950/80 border border-neutral-800 p-4 rounded-xl space-y-2">
                  ...
                  <h4 className="text-sm font-bold text-neutral-100">Export or Batch ZIP</h4>
                  <p className="text-sm text-neutral-400">
            ...
            <div className="space-y-4">
              <div className="border border-neutral-800 bg-neutral-950 rounded-xl p-4 space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-sm font-bold text-neutral-100">1. Standard Snap (1:1 Native Pixel Crop)</h4>
                </div>
                ...
                <div className="bg-neutral-900 p-2 rounded text-xs font-mono text-emerald-400">
              ...
              <div className="border border-neutral-800 bg-neutral-950 rounded-xl p-4 space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-sm font-bold text-neutral-100">2. Max Area Fit (Maximum Field of View)</h4>
                </div>
                <p className="text-sm text-neutral-300">
                ...
                <div className="bg-neutral-900 p-2 rounded text-xs font-mono text-indigo-300">
              ...
              <div className="border border-neutral-800 bg-neutral-950 rounded-xl p-4 space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-sm font-bold text-neutral-100">3. Letterbox Pad (Zero Cropping)</h4>
                </div>
                <p className="text-sm text-neutral-300">
              ...
              <div className="bg-neutral-950 border border-neutral-800 rounded-xl p-4 space-y-3">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="bg-neutral-900 p-2.5 rounded border border-neutral-800">
                    ...
                    <ul className="mt-1 space-y-1 text-neutral-400 font-mono text-xs">
